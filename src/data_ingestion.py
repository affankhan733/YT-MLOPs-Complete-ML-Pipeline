...
def load_data(data_url: str) -> pd.DataFrame:
    try:
        ...
        logger.error('Unexpcted error occured while loading the file: %s', e)
        raise
...
def main():
    try:
        test_size = 0.2
        data_path = 'https://raw.githubusercontent.com/affankhan733/Dataset/refs/heads/main/spam%20(1).csv'
